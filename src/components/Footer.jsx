...
import { Box, Typography, IconButton, bottomNavigationActionClasses } from '@mui/material';
  ...
  return (
    <Box component="footer" sx={{
      ...
      <Box>
        ...
        <IconButton href="https://github.com/TV-Code" target="_blank" rel="noopener noreferrer" color="inherit" sx={{ height: "40px", width: "40px", margin: "10px"}}>
          <GitHubIcon />
        </IconButton>
